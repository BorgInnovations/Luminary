...
function topMenu_load() {
  document.getElementById("topMenu").innerHTML = '<ul><li><a href="https://borginnovations.com">B0RG</a></li><li><a class="nbus" onclick="showproducts()">Projects</a></li><li><a class="nbus" onclick="showcontact()">Contact</a></li></ul>'
