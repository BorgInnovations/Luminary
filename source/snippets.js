...
const documents = [
  ...
  { id: 4, title: 'LuminaryCSS Orange Button', search_content:'button html orange styled styles link a', content: '<a class="obus">obus Button</a>', author: 'Borg', language: 'HTML, CSS'},
  { id: 5, title: 'LuminaryCSS Blue Button', search_content:'button html blue styled styles link a', content: '<a class="bbus">obus Button</a>', author: 'Borg', language: 'HTML, CSS'},
  { id: 6, title: 'LuminaryCSS Green Button', search_content:'button html green styled styles link a', content: '<a class="gbus">obus Button</a>', author: 'Borg', language: 'HTML, CSS'},
  { id: 7, title: 'LuminaryCSS Deafult Button', search_content:'button html white styled styles link a', content: '<a class="abus">obus Button</a>', author: 'Borg', language: 'HTML, CSS'},
  { id: 8, title: 'LuminaryCSS Link', search_content:'button html default basic styled styles link a', content: '<a class="a">default link</a>', author: 'Borg', language: 'HTML, CSS'},
