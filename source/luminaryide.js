...
function sidebarSetSrc(){
  ...
  document.getElementById("sidebarembed").innerHTML = '<iframe src="'+document.getElementById("sidebarSrc").value+'" id="sidebar" class="card" style="width: 90%; height: 300px; margin: 0px;" frameborder="0" sandbox="allow-scripts"></iframe>  '
